...
export const WORLD_ZONES: ZoneDefinition[] = [
  ...
  },
  {
    ...
    cameraKeyframe: {
      progress: 0.23,
      position: new THREE.Vector3(-0.9, 1.25, -11.5),
      target: new THREE.Vector3(0.8, 0.65, -14.0),
      fov: 38,
    },
  ...
  },
  {
    ...
    cameraKeyframe: {
      progress: 0.40,
      position: new THREE.Vector3(0.9, 1.20, -25.5),
      target: new THREE.Vector3(-0.8, 0.50, -28.0),
      fov: 38,
    },
  ...
  },
  {
    ...
    cameraKeyframe: {
      progress: 0.55,
      position: new THREE.Vector3(-0.6, 2.2, -39.5),
      target: new THREE.Vector3(0.8, 1.4, -42.0),
      fov: 38,
    },
  ...
  },
  {
    ...
    cameraKeyframe: {
      progress: 0.70,
      position: new THREE.Vector3(0.4, 1.2, -53.2),
      target: new THREE.Vector3(-1.0, 0.7, -56.0),
      fov: 38,
    },
  ...
  },
  {
    ...
    cameraKeyframe: {
      progress: 0.85,
      position: new THREE.Vector3(0.0, 1.6, -66.5),
      target: new THREE.Vector3(0.0, 0.6, -70.0),
      fov: 40,
    },
  ...
  },
  {
    ...
    cameraKeyframe: {
      progress: 0.96,
      position: new THREE.Vector3(0.0, 1.1, -81.0),
      target: new THREE.Vector3(0.0, 0.7, -84.0),
      fov: 36,
    },

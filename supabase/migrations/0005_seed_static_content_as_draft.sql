...
INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('ROS 2 (Robot Operating System)', 'Robotics & Control', 'ROS 2 node architecture and spatial navigation', 'ROS 2 Ecosystem', 'Advanced', 0, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Autonomous Kinematics & Control', 'Robotics & Control', 'Proportional steering and closed-loop feedback control', 'Kinematics & Control', 'Advanced', 1, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Path Planning (A*, Dijkstra, BFS)', 'Robotics & Control', 'Graph traversal and heuristic spatial search', 'Spatial Navigation', 'Advanced', 2, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Obstacle Avoidance & Perception', 'Robotics & Control', 'Proximity perception and avoidance maneuvering', 'Perception & Safety', 'Advanced', 3, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('State Machine Coordination', 'Robotics & Control', 'Deterministic state machines for mission sequencing', 'Mission Sequencing', 'Advanced', 4, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Coordinate Transformations (TF2)', 'Robotics & Control', 'Coordinate frames and dynamic transformation trees', 'Spatial Frames', 'Advanced', 5, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Closed-Loop Feedback Systems', 'Robotics & Control', 'Sensor feedback regulation and stability control', 'Feedback Control', 'Advanced', 6, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Machine Learning Pipelines', 'AI & ML', 'End-to-end model training, validation, and evaluation pipelines', 'Pipelines & Workflow', 'Advanced', 7, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Scikit-Learn & NumPy', 'AI & ML', 'Scientific computing and vectorized mathematical operations', 'Numerical Modeling', 'Advanced', 8, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Classification & Regression', 'AI & ML', 'Supervised predictive modeling and loss optimization', 'Statistical Learning', 'Advanced', 9, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Decision Trees & SVMs', 'AI & ML', 'Non-linear kernel boundaries and decision boundary analysis', 'Algorithmic Classifiers', 'Advanced', 10, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Computer Vision & Image Processing', 'AI & ML', 'Spatial feature extraction and visual filtering', 'Vision & Optics', 'Advanced', 11, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Data Preprocessing & EDA', 'AI & ML', 'Exploratory feature distribution and outliers cleansing', 'Data Engineering', 'Advanced', 12, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Embedded C / C++', 'Firmware & Embedded', 'Real-time firmware programming and bare-metal registers', 'Systems Programming', 'Advanced', 13, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Python Systems Programming', 'Firmware & Embedded', 'POSIX sockets, IPC, and peripheral bus automation', 'Hardware Interfacing', 'Advanced', 14, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Microcontroller Architectures', 'Firmware & Embedded', 'ARM Cortex-M and AVR peripheral interrupt handling', 'Embedded Compute', 'Advanced', 15, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Serial Protocols (UART / I2C / SPI)', 'Firmware & Embedded', 'Deterministic low-latency hardware bus communication', 'Serial Busses', 'Advanced', 16, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Real-Time Sensor Interfacing', 'Firmware & Embedded', 'Interrupt-driven telemetry streaming and ADC sampling', 'Sensor Integration', 'Advanced', 17, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Circuit Prototyping & Debugging', 'Hardware & Circuits', 'Oscilloscope telemetry analysis and power plane debugging', 'Circuit Diagnostics', 'Advanced', 18, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('PCB Design Fundamentals', 'Hardware & Circuits', 'Schematic layout, trace impedance, and routing topology', 'EDA & PCB Layout', 'Advanced', 19, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Sensor & Actuator Calibration', 'Hardware & Circuits', 'PWM drive linearity and ADC scale calibration', 'Actuation & Sensors', 'Advanced', 20, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Power Distribution Basics', 'Hardware & Circuits', 'Buck/boost regulation and transient protection', 'Power Electronics', 'Advanced', 21, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Linux / Ubuntu Environment', 'Software & Tools', 'POSIX CLI, systemd daemon management, and kernel modules', 'OS & Environment', 'Advanced', 22, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Git & Collaborative CI/CD', 'Software & Tools', 'Semantic versioning and automated testing workflows', 'Version Control & CI', 'Advanced', 23, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Data Visualization (Matplotlib/Seaborn)', 'Software & Tools', 'Statistical chart plotting and experimental data analysis', 'Analytics & Plotting', 'Advanced', 24, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Algorithm Complexity Optimization', 'Software & Tools', 'Asymptotic analysis and data structure memory tuning', 'Algorithm Optimization', 'Advanced', 25, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;

INSERT INTO public.skills (name, category, description, subdiscipline, proficiency_level, display_order, publication_status, verification_status, last_verified) VALUES ('Technical Documentation', 'Software & Tools', 'Architecture specifications and research reproducibility logs', 'Technical Writing', 'Advanced', 26, 'draft', 'USER_PROVIDED', '2026-09-06T17:49:13.221Z') ON CONFLICT DO NOTHING;
